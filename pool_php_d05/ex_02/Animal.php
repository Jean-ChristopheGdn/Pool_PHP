...
public function getNumberOfAnimalsAlive()
	{
		...
		elseif (self::$NumberOfAnimalsAlive > 1)
		{
			echo "There are currently ".self::$NumberOfAnimalsAlive. " animals alive in our world.".PHP_EOL;
			
		}
		elseif (self::$NumberOfAnimalsAlive == 0)
		{
			echo "There is currently ".self::$NumberOfAnimalsAlive." animals alive in our world.".PHP_EOL;
		}
...
public function getNumberOfMammals()
	{
		...
		elseif (self::$NumberOfMammals  > 1)
		{
			echo "There are currently ".self::$NumberOfMammals ." mammals alive in our world.".PHP_EOL;
		}
				elseif (self::$NumberOfMammals == 0)
		{
			echo "There is currently ".self::$NumberOfMammals ." mammals alive in our world.".PHP_EOL;
		}
...
public function getNumberOfBirds()
	{
		...
		elseif (self::$NumberOfBirds  > 1)
		{
			echo "There are currently ".self::$NumberOfBirds ." birds alive in our world.".PHP_EOL;
		}
		elseif (self::$NumberOfBirds == 0)
		{
			echo "There is currently ".self::$NumberOfBirds ." birds alive in our world.".PHP_EOL;
		}
