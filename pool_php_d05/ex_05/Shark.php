...
private $frenzy = false;
	...
	public function eat($proie)
	{	
		$this->name;
		if ($proie == get_class::Shark)
		{
			$this->name.": It's not worth my time.".PHP_EOL;
		}
		echo $this->name." ate a ".$proie->getType()." named ".$proie->getName().PHP_EOL;
